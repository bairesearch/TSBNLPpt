...
y9 = np.array([25.0, 14.952799797058105, 9.847137451171875, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan])
y10 = np.array([25.0, 14.95771312713623, 9.411134719848633, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan])
y11 = np.array([25.0, 13.122990608215332, 8.640877723693848, 7.411283016204834, 6.516513824462891, 6.19566535949707, 5.961752414703369, 5.528520107269287, np.nan ])
y12 = np.array([25.0, 14.354602813720703, 10.125027656555176, 8.795341491699219, 7.866785049438477, 7.464639663696289, 7.118199825286865, 6.609375, 6.504546642303467])
...
plt.legend(handles=[l2, l3, l6, l7, l8, l9, l10, l11, l12])

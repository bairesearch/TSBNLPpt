...
class RobertaSelfAttention(nn.Module):
	def __init__(self, config, robertaSharedLayerModules=None, position_embedding_type=None):
		...
		if(tokenMemoryBank):
			self.tokenMemoryBankClass = SBNLPpt_transformerTokenMemoryBank.TokenMemoryBankClass(config)
...
#SBNLPpt_transformerModel specific code;
